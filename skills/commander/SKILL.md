...
Multiple failures AND they are independent AND no shared state → **parallel dispatch** (COMMANDER)
Multiple failures AND related → single agent investigates all
No shared state but sequential → sequential agents
