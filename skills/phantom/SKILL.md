...
| Condition | Use |
|---|---|
| Have plan + independent tasks + stay in session | **PHANTOM** |
| Have plan + want parallel fresh session | **EXODUS** |
| No plan yet | Design first (ARCHITECT → BLUEPRINT) |
| Tasks tightly coupled | Manual execution |
