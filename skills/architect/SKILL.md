...
**The terminal state is invoking blueprint.** Do NOT invoke frontend-design, mcp-builder, or any other implementation skill. The ONLY skill you invoke after architect is blueprint.
...
`skills/architect/visual-companion.md`
