...
1. **Create Failing Test Case**
   ...
   - Use the `superpowers:forge` skill for writing proper failing tests
...
**Related skills:**
- **superpowers:forge** - For creating failing test case (Phase 4, Step 1)
- **superpowers:sentinel** - Verify fix worked before claiming success
